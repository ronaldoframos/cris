...
st.set_page_config(page_title="Mutua Beneficios", page_icon="🤖", layout="wide")
...
if "view_mode" not in st.session_state:
    st.session_state.view_mode = "chat"  # Modo inicial é o chat

# Função para alternar entre os modos de visualização
def set_view_mode(mode):
    st.session_state.view_mode = mode

# Cabeçalho com fundo vermelho e título centralizado


# Menu na barra lateral para alternar entre visualizações
with st.sidebar:
    if st.button("Modo Visualização"):
        if st.session_state.view_mode == "visualizar":
            set_view_mode("chat")
        else:
            set_view_mode("visualizar")

# Exibir conteúdo conforme a opção selecionada
if st.session_state.view_mode == "chat":
    ...
    st.markdown(
        ...
        <div class="header">
            Olá. Eu sou a Cris, seu assistente para concessão de benefícios da Mútua.
        </div>
        """,
    ...
    #################### Coloque aqui o código do chat conforme o script original
    #st.markdown("</div>", unsafe_allow_html=True)

elif st.session_state.view_mode == "visualizar":
    #############
    visualizar()
    # Coloque aqui o código para visualização de dados, como st.dataframe ou st.table
    #############
    #st.markdown("</div>", unsafe_allow_html=True)
